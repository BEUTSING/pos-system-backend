 ...
 */
final class Version20250711142539 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE invoice (id INT AUTO_INCREMENT NOT NULL, productname_id INT DEFAULT NULL, saledate_id INT DEFAULT NULL, customernam_id INT DEFAULT NULL, name_user_id INT DEFAULT NULL, customername VARCHAR(255) NOT NULL, quantity INT NOT NULL, price NUMERIC(10, 6) NOT NULL, totaux NUMERIC(10, 6) NOT NULL, INDEX IDX_90651744EA583AF1 (productname_id), INDEX IDX_9065174435C5DF2A (saledate_id), INDEX IDX_90651744332F3B2F (customernam_id), INDEX IDX_90651744AF05962B (name_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE stockmovement (id INT AUTO_INCREMENT NOT NULL, product_id INT DEFAULT NULL, username_id INT DEFAULT NULL, quantity INT NOT NULL, typemovement VARCHAR(50) NOT NULL, datemovement DATE NOT NULL, reason VARCHAR(255) NOT NULL, INDEX IDX_993364294584665A (product_id), INDEX IDX_99336429ED766068 (username_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE users (id INT AUTO_INCREMENT NOT NULL, contact_id INT DEFAULT NULL, username VARCHAR(255) NOT NULL, role VARCHAR(255) NOT NULL, password VARCHAR(50) NOT NULL, color VARCHAR(255) NOT NULL, INDEX IDX_1483A5E9E7A1254A (contact_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE invoice ADD CONSTRAINT FK_90651744AF05962B FOREIGN KEY (name_user_id) REFERENCES users (id)');
        ...
        $this->addSql('ALTER TABLE stockmovement ADD CONSTRAINT FK_99336429ED766068 FOREIGN KEY (username_id) REFERENCES users (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE invoice DROP FOREIGN KEY FK_90651744AF05962B');
        ...
        $this->addSql('ALTER TABLE stockmovement DROP FOREIGN KEY FK_99336429ED766068');
