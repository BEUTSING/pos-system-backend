 ...
 */
final class Version20250804140751 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cancellation ADD user_id INT NOT NULL, ADD user VARCHAR(50) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cancellation DROP user_id, DROP user');
    }
}
