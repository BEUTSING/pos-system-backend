...
final class UsersController extends AbstractController
{
    ...
    #[Route('/user/Users ', name: 'app_Users _create', methods: ['POST'])]
    #[OA\Post(
        path:'/api/v1/user/Users ',
        summary: "User registration",
        description: "Allows Users ing a new user with name, phone, city, color, email, and password.",
    ...
    #[OA\Get(
        ...
        description: "Retrieves a list of all Users ed users with their details.",
        responses:[
            new OA\Response(
                response:200,
   ...
   #[OA\Put(
    ...
    public function updateUsers (Request $request,int $id): JsonResponse{
     ...
     public function deleteUser(int $id): JsonResponse{
       try{
            $data=$this->UsersSercice->deleteusers($id);
